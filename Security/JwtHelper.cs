...
public class JwtHelper
{
    ...
    /// <summary>
    /// Sinh Access Token d?ng JWT d?a vào thông tin ngu?i dùng.
    /// </summary>
    /// <param name="userId">ID ngu?i dùng.</param>
    /// <param name="username">Tên dang nh?p.</param>
    /// <param name="typeAccount">Lo?i tài kho?n (Admin/Player).</param>
